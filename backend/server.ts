 ...
 * Villa Details [GET]
 */
app.get('/villa/:villa_id', asyncWrap(async (req, res) => {
  /*
  ...
  */
  ...
  try {
    ...
    const villa = rows[0];
    const [v, err] = safeParse(villaSchema, villa);
    if (err) throw err;
    return res.json(v);
  } finally { client.release(); }
}));
 ...
 * Villa Details [PATCH]
 */
app.patch('/villa/:villa_id', requireAuth, asyncWrap(async (req, res) => {
  /*
 ...
 * Villa Photos [GET]
 */
app.get('/villa/:villa_id/photos', asyncWrap(async (req, res) => {
  /*
 ...
 * Villa Amenities [GET]
 */
app.get('/villa/:villa_id/amenities', asyncWrap(async (req, res) => {
  /*
 ...
 * Villa Rules [GET]
 */
app.get('/villa/:villa_id/rules', asyncWrap(async (req, res) => {
  /*
 ...
 * Villa Calendar [GET]
 */
app.get('/villa/:villa_id/calendar', asyncWrap(async (req, res) => {
  /*
 ...
 */
app.get('/villa/:villa_id/pricing-overrides', asyncWrap(async (req, res) => {
  const villa_id = req.params.villa_id;
  const client = await pool.connect();
  try {
    const { rows } = await client.query(
...
// ... More route implementations below to cover the full OpenAPI spec (Bookings, Wishlists, Messaging, Reviews, Notifications, etc.)
