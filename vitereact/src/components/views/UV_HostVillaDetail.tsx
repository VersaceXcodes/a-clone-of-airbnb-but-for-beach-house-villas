            ...
            <div className="w-full md:w-3/5 flex flex-col gap-3">
              <div className="flex flex-row justify-between items-center">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-lg font-semibold">{avg_rating.toFixed(2)}</span>
              ...
              <div className="flex gap-4 mt-2">
                <div>
                  ...
                  <span className="ml-1">${villa.price_per_night.toFixed(2)}</span>
                </div>
                <div>
                  <span className="font-medium">Cleaning fee:</span>
                  <span className="ml-1">${villa.cleaning_fee.toFixed(2)}</span>
                </div>
              </div>
              <div className="flex gap-4 mt-2">
                <Link
